define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'welcome'], name: 'welcome', moduleId: './welcome', nav: true, title: 'Welcome' }, { route: ['kata', 'kata'], name: 'kata', moduleId: './kata', nav: true, title: 'Profile' }]);
...
define('main',['exports', './environment', './node_modules/gun/gun.js', 'bootstrap'], function (exports, _environment, _gun) {
  'use strict';
