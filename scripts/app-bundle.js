...
define('service/kata-service',['exports', 'aurelia-framework', '../user', 'pouchdb-browser'], function (exports, _aureliaFramework, _user, PouchDB) {
    'use strict';
    ...
    var KataService = exports.KataService = (_dec = (0, _aureliaFramework.inject)(_user.User), _dec(_class = function () {
        ...
        KataService.prototype.getKatas = function getKatas(f) {};
